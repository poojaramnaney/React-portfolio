          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Pawan Kumar Singh`} <br></br><span className="txt-rotate" dataPeriod="100" data-rotate='[ "Data Analyst", "Data Scientist", "Machine Learning Enthusiast", "Web3 Enthusiast" ]'><span className="wrap">{text}</span></span></h1>
